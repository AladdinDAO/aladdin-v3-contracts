...
export const TOKENS: { [symbol: string]: { address: string; decimals: number } } = {
  ...
  aCRV: { decimals: 18, address: "0x2b95A1Dcc3D405535f9ed33c219ab38E8d7e0884" },
  aCVX: { decimals: 18, address: "0xb0903Ab70a7467eE5756074b31ac88aEBb8fB777" },
  aFXN: { decimals: 18, address: "0x00Bac667a4cCf9089aB1Db978238C555C4349545" },
  aFXS: { decimals: 18, address: "0xDAF03D70Fe637b91bA6E521A32E1Fb39256d3EC9" },
  afrxETH: { decimals: 18, address: "0xb15Ad6113264094Fd9BF2238729410A07EBE5ABa" },
  ...
  asdCRV: { decimals: 18, address: "0x43E54C2E7b3e294De3A155785F52AB49d87B9922" },
...
TOKENS["CURVE_S_NG_USDC/fxUSD_193"] = { decimals: 18, address: "0x5018be882dcce5e3f2f3b0913ae2096b9b3fb61f" };
TOKENS["CURVE_S_NG_USD0/fxUSD_195"] = { decimals: 18, address: "0x74c204520c9e88aa3eb9d61788aba11be1e0193f" };
TOKENS["CURVE_S_NG_fxUSD/rUSD/btcUSD_204"] = { decimals: 18, address: "0x52bf165abd26106d810733cc29faff68b96dece8" };
TOKENS["CURVE_S_NG_fxUSD/USDN_387"] = { decimals: 18, address: "0xB6aF437ceEa0DBeA524115eFC905F0F44fd1eBAF" };
TOKENS["CURVE_S_NG_reUSD/fxUSD_414"] = { decimals: 18, address: "0xb0ef04ACE97d350E24Efa5139d2590D26a61A8Dc" };
TOKENS["CURVE_S_NG_fxSAVE/scrvUSD_475"] = { decimals: 18, address: "0xb6E4821c6fCABe32f5F452dfD3Ef20Ce2A3a48E2" };
TOKENS["CURVE_S_NG_msUSD/fxUSD_512"] = { decimals: 18, address: "0x138Bb0f3208bd729a561F3786DDb97BBc69e6628" };
TOKENS["CURVE_S_NG_fxUSD/USDC/USDaf/BOLD_546"] = { decimals: 18, address: "0x8B878AFE454e31CF0A79c6D7cf2f077DD286C12f" };
TOKENS["CURVE_S_NG_DOLA/fxSAVE_569"] = { decimals: 18, address: "0x2b854e225d7282854819327D0CA5b8D8AA8CAaED" };
TOKENS["CURVE_S_NG_ynUSDx/fxUSD_591"] = { decimals: 18, address: "0x77145b34807D04fd35D85796CBC81fe65365704A" };
...
TOKENS["CRV_2C_WETH/fxUSD_307"] = { decimals: 18, address: "0xb2ee8f9622C5A480928836c0575df7d150f72d98" };
