...
export const ZAP_ROUTES: { [from: string]: { [to: string]: bigint[] } } = {
  ...
  USDC: {
    ...
    cvxFXN: [
      ...
      encodePoolHintV2(ADDRESS["CURVE_FXN/cvxFXN_POOL"], PoolType.CurveFactoryPlainPool, 2, 0, 1, Action.Swap),
    ],
    cvxFXS: [
      encodePoolHintV2(ADDRESS.CURVE_FRAXUSDC_POOL, PoolType.CurveBasePool, 2, 1, 0, Action.Swap),
      encodePoolHintV2(ADDRESS.FXS_FRAX_UNIV2, PoolType.UniswapV2, 2, 1, 0, Action.Swap),
  ...
  cvxFXN: {
    WETH: [
      encodePoolHintV2(ADDRESS["CURVE_FXN/cvxFXN_POOL"], PoolType.CurveFactoryPlainPool, 2, 1, 0, Action.Swap),
...
export const PATH_ENCODING: { [name: string]:  bigint } = {
  ...
  "CRV-WETH-UniV2": encodePoolHintV3(ADDRESS["UniV2_WETH/CRV"], PoolTypeV3.UniswapV2, 2, 1, 0, Action.Swap, {fee_num: 997000}),
  ...
  "DINERO-WETH-UniV3": encodePoolHintV3(ADDRESS["UniV3_DINERO/WETH_3000"], PoolTypeV3.UniswapV3, 2, 0, 1, Action.Swap, {fee_num: 3000}),
  ...
  "MET-USDC-UniV3": encodePoolHintV3(ADDRESS["UniV3_MET/USDC_3000"], PoolTypeV3.UniswapV3, 2, 0, 1, Action.Swap, {fee_num: 3000}),
  ...
  "WETH-SDT-Crv2C-NG": encodePoolHintV3(ADDRESS["CRV_2C_WETH/SDT_51_POOL"], PoolTypeV3.CurveCryptoPool, 2, 0, 1, Action.Swap),
  ...
  sdCRV: {
    SDT: encodeMultiPath(
      [
        ...
        [PATH_ENCODING["sdCRV-CRV-CrvP-300"], PATH_ENCODING["CRV-WETH-UniV2"], PATH_ENCODING["WETH-SDT-UniV2"]],
        [PATH_ENCODING["sdCRV-CRV-CrvP-300"], PATH_ENCODING["CRV-WETH-UniV3"], PATH_ENCODING["WETH-SDT-Crv2C-NG"]],
