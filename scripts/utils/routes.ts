...
export const ZAP_ROUTES: { [from: string]: { [to: string]: BigNumber[] } } = {
  ...
  FXS: {
    // FXS ==(UniV3)==> WETH
    WETH: [encodePoolHintV2(ADDRESS.FXS_WETH_UNIV3_10000, PoolType.UniswapV3, 2, 0, 1, Action.Swap)],
  ...
  INV: {
    ...
    // INV ==(Sushi)==> WETH
    WETH: [encodePoolHintV2(ADDRESS.INV_WETH_UNIV2, PoolType.UniswapV2, 2, 0, 1, Action.Swap)],
  },
  JPEG: {
    // JPEG ==(UniV2)==> WETH
