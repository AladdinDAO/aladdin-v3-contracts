...
export const ADDRESS: { [name: string]: string } = {
  ...
  CURVE_CLEVETH_POOL: "0x19a0d1D428425ef397966Bce6c798bEDC3030035",
  CURVE_CLEVETH_TOKEN: "0x167dE3887eDEbE5012544373C5871481bD95Cc4e",
  // Curve clevCVX/CVX, to be changed
  CURVE_CLEVCVX_POOL: "0x930792bd0fb4593063Ad2ee12E86d768bD8DF7a1",
  CURVE_CLEVCVX_TOKEN: "0x930792bd0fb4593063Ad2ee12E86d768bD8DF7a1",
  // Curve SILO/FRAX
