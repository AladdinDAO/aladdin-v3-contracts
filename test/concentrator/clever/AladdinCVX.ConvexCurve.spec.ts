...
import { AMOConvexCurveStrategy, MockERC20 } from "../../../typechain";
...
const FORK_BLOCK_NUMBER = 16426870;
...
describe("AladdinCVX.ConvexCurve.spec", async () => {
  ...
  beforeEach(async () => {
    ...
    const AMOConvexCurveStrategy = await ethers.getContractFactory("AMOConvexCurveStrategy", deployer);
    strategy = await AMOConvexCurveStrategy.deploy();
